...
import '../Viewmodels/byte_rating_provider.dart';
...
class _StarDisplay extends StatelessWidget {
  ...
  const _StarDisplay({required this.rating, this.size = 18, this.filledColor = const Color(0xFFFFB800)});
  @override
        ...
        child: Column(mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Center(child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                SizedBox(width: 4),
                Text('$_rating / 5', style: TextStyle(fontSize: 13,
