...
class Taiken {
  ...
  // ── Creator display fields (joined from user_profiles) ────────────────────
  /// The creator's display username. Populated when fetching list views.
  final String? creatorUsername;

  /// The creator's profile picture URL. Populated when fetching list views.
  ...
  factory Taiken.fromJson(Map<String, dynamic> json) => Taiken(
    ...
    creatorProfilePic:   json['creator_profile_pic'] as String?,
  );
  ...
  Taiken copyWith({
    ...
    String? creatorProfilePic,
      ...
      Taiken(
        ...
        creatorProfilePic:      creatorProfilePic   ?? this.creatorProfilePic,
      );
