...
import '../Viewmodels/content_event_tracker.dart' hide ContentType; // ✅ ADDED
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Share', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
          SizedBox(height: 24),
          ListTile(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('More Options', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
          SizedBox(height: 16),
          ListTile(
